        ...
        __prepareGC: function() {
            ...
            if (self.__options.selfDestruction) {
                ...
                self.__garbageCollector = setInterval(function() {
                    ...
                    self.__touchEvents = $.grep(self.__touchEvents, function(
                        event,
                        i
                    ) {
                        // 1 minute
                        ...
                        if (self.__Content !== null) {
                            ...
                            var extraTime,
                                finish = function() {
                                    ...
                                    $.each(self.__callbacks.open, function(
                                        i,
                                        c
                                    ) {
                                        c.call(self, self, {
    ...
    $.tooltipster._plugin({
        ...
        instance: {
            ...
            __init: function(instance) {
                ...
                self.__instance._on('state.' + self.__namespace, function(
                    event
                ) {
                ...
                self.__instance._on('reposition.' + self.__namespace, function(
                    e
                ) {
            ...
            __reposition: function(event, helper) {
                ...
                $.each(['window', 'document'], function(i, container) {
                    ...
                    if (
                        ...
                        for (var i = 0; i < self.__options.side.length; i++) {
                            ...
                            $.each(['natural', 'constrained'], function(
                                i,
                                mode
                            ) {
                                takeTest = null;
                ...
                helper.tooltipParent = self.__instance.option(
                    'parent'
                ).parent[0];
